...
export default function HelloWorld() {
    return (
        <div className="align-items: center; ">
            <h1 className=" m-4">Belajar Tailwind CSS 4</h1>
...
function Spacing() {
    return (
        <div className="bg-white shadow-lg p-6 m-9 rounded-lg">
...
function BorderRadius() {
    return (
        <div className="flex flex-col items-center text-center">
        <button className="border-2 mt-7 mb-10 border-blue-500 text-blue-500 px-4 py-2 rounded-lg">
            Klik Saya
        </button>
        </div>
    );
...
function BackgroundColors() {
    return (
        <div className="bg-blue-500 text-white p-6 mb-10 rounded-lg shadow-lg">
            <h3 className="text-xl font-bold">Tailwind Colors</h3>
            <p className="mt-5">Belajar Tailwind itu seru dan fleksibel!</p>
        </div>
    );
}
...
function FlexboxGrid() {
    return (
        <nav className="flex mb-10 justify-between bg-gray-800 p-4 text-white">
